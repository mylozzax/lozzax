...
RUN	git clone https://github.com/lozzax-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/lozzax-project/lozzax
...
if [ ! -d sigs ]; then
	git clone https://github.com/lozzax-project/gitian.sigs.git sigs
	cd sigs
