# Lozzax Blockchain Stats

Lozzax Blockchain Stats utlity exports daily statistics for the monero blockchain from creation through current state.

## Usage:

See also the utility's help option. `lozzax-blockchain-stats --help`
...
- `lozzax-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `lozzax-blockchain-stats | save-to-database.sh`
